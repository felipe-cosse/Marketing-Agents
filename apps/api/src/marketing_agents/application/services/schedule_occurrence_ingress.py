...
from marketing_agents.domain.entities import Run, ScheduleClaim, ScheduleOccurrence, WorkItem
    ...
    async def admit_claimed_once(
        ...
        async with self._dependencies.unit_of_work() as unit_of_work:
            ...
            occurrence_id = schedule_occurrence_id(
                command.claim.schedule_id,
                command.claim.scheduled_for_utc,
                recurrence_version=command.claim.recurrence_version,
            )
            ...
            pending = ScheduleOccurrence(
                ...
                scheduled_for_utc=command.claim.scheduled_for_utc,
