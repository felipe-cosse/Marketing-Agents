...
class AuditEventRecord(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint(
            ...
            "('ingress.rate_limited','webhook.signature_validated',"
            "'webhook.signature_rejected','webhook.received',"
            ...
            "(event_type = 'ingress.rate_limited' AND actor_source = 'service' AND "
            "auth_method = 'verified_webhook' AND outcome = 'rejected' AND "
            "mutation_version IS NULL AND reason_code = 'rate_limit_exhausted') OR "
