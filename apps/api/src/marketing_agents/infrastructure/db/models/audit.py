...
class AuditEventRecord(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint(
            ...
            "(event_type = 'action.cancelled' AND action_attempt_number IS NULL AND "
            "receipt_id IS NULL AND mutation_version >= 3 AND "
            "previous_state IN ('awaiting_approval','approved') AND "
            "new_state = 'cancelled') OR "
